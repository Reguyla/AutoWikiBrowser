...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        private static readonly List<string> MultipleIssuesArticleMaintenanceTemplatesList = new[]
        {
            ...
            "Copy to Wikibooks", "Copy to Wikiquote", "Copy to Wikisource", "Copy to Wikiversity", "Copy to Wikivoyage", "Copypaste", "Create list", "Criticism section", "Current", "Current election", "Current person", "Current related", "Current spaceflight", "Current sport", "Current weather event",
            "Dablinks", "Dead end", "Deprecated archival service", "Dicdef", "Directory", "Dispute about", "Disputed", "Disputed category", "Disputed chem", "Disputed list", "Disputed map", "Duplicated citations", "Duplication",
            "EBD POV", "Essay", "Essay-like", "Excessive citations", "Excessive examples", "Exit list", "Expert needed", "External links", "Famous", "Fan POV",
            "Fiction", "Fiction trivia", "Format footnotes", "Fringe theories", "Full citations needed", "Further reading cleanup",
            "Game guide", "Generalize", "Globalize",
            "Hoax", "Hook", "How-to",
            "Improve images", "Inappropriate person", "Incoming links", "incomplete disambiguation", "Incomplete list", "Inc-personnel", "Inc-results", "Independent sources", "In popular culture", "In-universe", "Infobox too large",
            "Lacking ISBN", "Lacking overview", "Lead extra info", "Lead missing", "Lead rewrite", "Lead too long", "Lead too short", "List missing criteria", "list scope", "List to table", "List years", "Localist", "Long plot",
            "Media IMDb refimprove", "Merge", "Merge from", "Merge portions from", "Merge to", "Merging from", "Missing information", "Missing taxobox", "More citations needed",
            "More footnotes needed", "More medical citations needed", "More plot", "More science citations needed", "Mycomorphbox missing",
            "Needs table", "Neologism", "New name", "No footnotes", "No plot", "No reliable sources", "No significant coverage", "No significant coverage (sports)", "Non-free", "Notability", "Not English", "NPOV language", "NRIS only", "Obituary", "Off topic", "Old news", "One other topic", "One source",
            "Only primary sources", "Original research", "Orphan", "Outdated as of", "Overlinked", "Overly detailed", "Over-quotation",
            "Page numbers improve", "Page numbers needed", "Paid contributions", "Parenthetical referencing", "Peacock", "POV", "Political POV", "Primary sources", "Pro and con list", "Proofreader needed", "Promotional", "Prose",
            "Recategorize", "Recent birth", "Recent death", "Recentism", "Recently revised", "Religious text primary", "Renamed", "Renamed from", "Research paper", "Resume-like", "Review", "Rough translation",
            ...
            "Expand Limburgish", "Expand Lithuanian", "Expand Lombard", "Expand Luxembourgish",
            ...
            "Expand Telugu", "Expand Thai", "Expand Tibetan", "Expand Tongan", "Expand Tswana",
        ...
        "Db-nonsense", "Template:Db-notenglish", "Template:Db-notwebhost", "Template:Db-org", "Template:Db-owner","Db-p1", "Template:Db-p2", "Template:Db-pagemove", "Template:Db-peo",
        "Template:Db-people", "Template:Db-person", "Template:Db-promo", "Template:Db-r1", "Template:Db-r2", "Template:Db-r3", "Db-redirect", "Template:Db-redirmisnomer", "Template:Db-redirnone",
        "Template:Db-repost", "Template:Db-self", "Template:Db-site", "Template:Db-song", "Template:Db-spam", "Db-spamuser", "Template:Db-subpage", "Template:Db-t3", "Template:Db-talk",
        "Template:Db-templatecat", "Template:Db-test", "Template:Db-transwiki", "Db-tw", "Template:Db-u", "Template:Db-u1", "Template:Db-u2", "Template:Db-u3", "Template:Db-u5", "Template:Db-user",
        "Template:Db-userpage", "Template:Db-vand", "Template:Db-vandalism", "Db-web", "Template:Db-webhost", "Template:Db-website", "Template:Db-xfd", "Dbe", "Template:Declinedsd", "Template:Delbecause",
        "Template:Delete", "Template:Delete because", "Template:Delete when empty", "Template:DeleteVanity", "Deletebecause", "Template:Deletevanity", "Template:Duplicate", "Template:Dv", "Template:Empty",
        "Template:Hang on", "Template:Hangon click preload", "Hangon preload C1", "Template:Nocontent", "Template:Nocontext", "Template:Notg4", "Template:Oldcsd", "Template:Oldcsdfull", "Template:Salt",
        "Template:Sdd", "Template:Sdd2", "Sdd3", "Template:Should be a user space test page please delete", "Template:Speedy", "Template:Speedy delete",
        "Speedy deletion templates", "Template:Speedydelete", "Db-speedy delete if article", "Template:Speedy deletion-nonfree galleries", "Template:Speedy deletion-foreign language",
        ...
        "Soft redirect protection", "Template:Sprot", "Template:Sprotect", "Template:Sprotect2", "Sprotected", "Template:Sprotected2", "Template:Temporarily protected",
