...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        private static readonly List<string> MultipleIssuesArticleMaintenanceTemplatesList = new[]
        {
            ...
            "Dablinks", "Dead end", "Deprecated archival service", "Dicdef", "Directory", "Dispute about", "Disputed", "Disputed category", "Disputed chem", "Disputed list", "Disputed map", "Duplicated citations", "Duplication", "EBD POV", "Essay", "Essay-like",
            "Excessive citations", "Excessive examples", "Exit list", "Expert needed", "External links", "Famous", "Fan POV",
            "Fiction", "Fiction trivia", "Format footnotes", "Fringe theories", "Full citations needed", "Further reading cleanup", "Game guide", "Generalize", "Globalize", "Hoax", "Hook", "How-to", "Improve images",
            "Inappropriate person", "Incoming links", "incomplete disambiguation", "Incomplete list", "Inc-personnel", "Inc-results", "Independent sources", "In popular culture", "In-universe", "Infobox too large",
            ...
            "Overly detailed", "Over-quotation", "Page numbers improve", "Page numbers needed", "Paid contributions", "Parenthetical referencing", "Peacock", "POV", "Political POV",
