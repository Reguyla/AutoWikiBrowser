...
partial class MainForm
{
    ...
    void IAutoWikiBrowserCommands.Stop(IAWBPlugin sender)
    {
        ((IAutoWikiBrowserCommands)this).Stop(sender.Name);
    }
    ...
    void IAutoWikiBrowserCommands.SkipPage(string sender, string reason)
    {
        SkipPage(reason);
    }
    void IAutoWikiBrowserCommands.Start(string sender)
    {
        BeginProcess();
    }
    void IAutoWikiBrowserCommands.Stop(string sender)
    {
        Stop();
    }
    void IAutoWikiBrowserCommands.GetDiff(string sender)
    {
        GetDiff();
    }
    void IAutoWikiBrowserCommands.GetPreview(string sender)
    {
        GetPreview();
    }
    void IAutoWikiBrowserCommands.Save(string sender)
    {
        Save();
    }
    ...
    {
        Tools.OpenENArticleInBrowser(article, false);
    }

    void IAutoWikiBrowserCommands.AddMainFormClosingEventHandler(FormClosingEventHandler handler)
    {
        FormClosing += handler;
    }

    void IAutoWikiBrowserCommands.StartProgressBar()
    {
        StartProgressBar();
    }
    void IAutoWikiBrowserCommands.StopProgressBar()
    {
        StopProgressBar();
    }
